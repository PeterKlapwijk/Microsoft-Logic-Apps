...
1. Enter the Key vault name and webhook-uri
...
For more informations and the **requirements** for this Logic Apps flow read the related [Blog Post](https://www.inthecloud247.com/get-your-windows-autopilot-deployment-events-in-a-teams-channel-with-logic-apps/)
