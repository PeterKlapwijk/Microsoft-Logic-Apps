...
az deployment group create `
    ...
    --template-file ../"Intune Windows Driver update approval reports"/bicep/WindowsDriverApprovalReport-root.bicep `
    --verbose
...
$ManagedIdentity = az identity show --name WINDriverApprovalReport-ManagedIdentity --resource-group $ResourceGroupName | ConvertFrom-Json
...
$appRoleIds = $DeviceManagementConfigurationReadAll
