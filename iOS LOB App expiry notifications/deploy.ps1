...
az deployment group create `
    ...
    --template-file ../"iOS LOB App expiry notifications"/bicep/iOSLOBAppExpiryNotifications-root.bicep `
    --verbose
...
$ManagedIdentity = az identity show --name LOBAppExpiryNotifications-ManagedIdentity --resource-group $ResourceGroupName | ConvertFrom-Json
...
$appRoleIds = $DeviceManagementAppsReadAll
