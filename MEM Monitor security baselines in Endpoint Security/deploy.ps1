...
az deployment group create `
    ...
    --template-file ../"MEM Monitor security baselines in Endpoint Security"/bicep/secBaselineMonitor-root.bicep `
    --verbose
...
$ManagedIdentity = az identity show --name SecBaselineMonitor-ManagedIdentity --resource-group $ResourceGroupName | ConvertFrom-Json
