...
az deployment group create `
    ...
    --template-file ../"Windows Driver auto approval Patch Tuesday"/bicep/WindowsDriverAutoApprovalPatchTuesday-root.bicep `
    --verbose
...
$ManagedIdentity = az identity show --name WINDriverAutoApproval-ManagedIdentity --resource-group $ResourceGroupName | ConvertFrom-Json
...
#Get appRoleIds
$DeviceManagementConfigurationReadWriteAll = az ad sp show --id $graphId --query "appRoles[?value=='DeviceManagementConfiguration.ReadWrite.All'].id | [0]" -o tsv

$appRoleIds = $DeviceManagementConfigurationReadWriteAll
