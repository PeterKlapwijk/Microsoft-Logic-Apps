param workflows_MonitorLicense_main_name string
...
resource workflows_MonitorLicense_main_name_resource 'Microsoft.Logic/workflows@2019-05-01' = {
  name: workflows_MonitorLicense_main_name
  location: resourceLocation
  identity: {
    type: 'UserAssigned'
    userAssignedIdentities: {
      '${resourceId('Microsoft.ManagedIdentity/userAssignedIdentities/',userAssignedIdentities_MonitorLicense_Identity_name)}': {}
    }
  }
  properties: {
    state: 'Enabled'
            ...
            HTTP_GET_one_Sku_enabled: {
              ...
              inputs: {
                authentication: {
                  ...
                  identity: resourceId('Microsoft.ManagedIdentity/userAssignedIdentities', userAssignedIdentities_MonitorLicense_Identity_name)
