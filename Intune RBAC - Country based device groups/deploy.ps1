# https://github.com/PeterKlapwijk ---- Original script from https://github.com/LuiseFreese
...
az deployment group create `
    ...
    --template-file ../"Intune RBAC - Country based device groups"/bicep/IntuneRBAC-root.bicep `
    --verbose
...
$ManagedIdentity = az identity show --name IntuneRBAC-ManagedIdentity --resource-group $ResourceGroupName | ConvertFrom-Json
...
$appRoleIds = $DeviceReadAll, $DeviceManagementManagedDevicesReadAll, $GroupMemberReadWriteAll, $UserReadAll
