...
$PermissionNames =  "DeviceManagementManagedDevices.Read.All", "Device.ReadWrite.All", "User.ReadWrite.All", "UserAuthenticationMethod.ReadWrite.All", "DeviceManagementManagedDevices.PrivilegedOperations.All", "SynchronizationData-User.Upload", "AuditLog.Read.All"
