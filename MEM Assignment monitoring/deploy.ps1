...
az deployment group create `
    ...
    --template-file ../"MEM Assignment monitoring"/bicep/AssignmentMonitoring-root.bicep `
    --verbose
...
$ManagedIdentity = az identity show --name MEMAssignment-ManagedIdentity --resource-group $ResourceGroupName | ConvertFrom-Json
...
#Get appRoleIds
$DeviceManagementConfigurationReadAll = az ad sp show --id $graphId --query "appRoles[?value=='DeviceManagementConfiguration.Read.All'].id | [0]" -o tsv
$DeviceManagementRBACReadAll = az ad sp show --id $graphId --query "appRoles[?value=='DeviceManagementRBAC.Read.All'].id | [0]" -o tsv
...
$DeviceManagementAppsReadAll = az ad sp show --id $graphId --query "appRoles[?value=='DeviceManagementApps.Read.All'].id | [0]" -o tsv 

$appRoleIds = $DeviceManagementConfigurationReadAll, $DeviceManagementRBACReadAll, $DeviceManagementServiceConfigReadAll, $DeviceManagementAppsReadAll
