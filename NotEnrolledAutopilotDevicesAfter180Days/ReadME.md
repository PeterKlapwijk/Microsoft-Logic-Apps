...
2. Navigate to the `NotEnrolledAutopilotDevicesAfter180Days` folder
...
5. Select **Sign in**
6. Select **Save**
7. Add the missing information to the SharePoint en Excel Online actions 
8. Check the Managed Identity on the HTTP actions
9. Add the Email Addresses in the Logic App to meet your needs.

*It takes a while before the Graph permissions are active, the first run of the flow might fail*

For more informations and the **requirements** for this Logic Apps flow read the related [Blog Post](https://www.inthecloud247.com/get-an-overview-of-windows-autopilot-registered-devices-that-are-not-enrolled-in-180-days/)
