...
az deployment group create `
    ...
    --template-file ../"NotEnrolledAutopilotDevicesAfter180Days"/bicep/NotEnrolledAutopilotDevicesAfter180Days-root.bicep `
    --verbose
...
$ManagedIdentity = az identity show --name Autopilot180days-ManagedIdentity --resource-group $ResourceGroupName | ConvertFrom-Json
...
$appRoleIds = $DeviceManagementServiceConfigReadAll, $DeviceReadAll
